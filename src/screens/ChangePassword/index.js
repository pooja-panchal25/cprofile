                    ...
                    <ScrollView bounces={false} showsVerticalScrollIndicator={false} >
                        <View style={styles.subView}>
                            <View style={styles.formView}>
                                <Text style={styles.headerText}>{strings('Label.ChangePassword')}</Text>
                                <Text style={styles.LabelText}>{strings('Label.ResetPasswordSubTitle')}</Text>
                                <LabeledInput
                                    onChangeText={(changeText) => this.setState({ oldPass: changeText })}
                                    value={this.state.oldPass}
                                    isLeftIcon={true}
                                    leftIcon={Icon.IcnLock}
                                    isRightIcon={true}
                                    rightIcon={this.state.oldPass ? Icon.IcnEyeBlank : Icon.IcnEyeFill}
                                    rightIconPress={() => this.setState({ secureTextEntryCurrPass: !this.state.secureTextEntryCurrPass })}
                                    secureTextEntry={this.state.secureTextEntryCurrPass}
