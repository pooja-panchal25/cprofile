      ...
      <SafeAreaView style={styles.Container}>
        <View style={styles.mainView}>
          <View style={styles.headerMain}>
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('EducatoinDetails')
              }>
            ...
            <View style={styles.subView}>
              <View style={styles.formView}>
                <Text style={styles.headerText}>
                  {strings('Label.AboutMe')}
                </Text>
                <Text style={styles.LabelText}>
                  {strings('Label.AboutSubText')}
                </Text>
                ...
                <View style={styles.labelView}>
                  <Text style={styles.inputLabel}>
                    {strings('Label.Affiliations')}
                  </Text>
                </View>
                <LabeledInput
                  onChangeText={changeText =>
                    this.setState({Affiliations: changeText})
                  }
                  value={this.state.Affiliations}
                  placeHolder={strings('PlaceHolders.WriteHere')}
                  multiline={true}
                  numberOfLines={10}
                  Containerstyle={{height: 150, paddingVertical: hp(2)}}
                />
              </View>
            </View>
            <ThemeButton
              onPress={() => this.props.navigation.navigate('EducatoinDetails')}
